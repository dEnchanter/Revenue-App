...
export default function Page() {
  ...
  const {
    ...
    user?.code == "00" 
    ? [Endpoint.FETCH_WARDS, tableState]
    : null,
    wardTableFetcher
  );
  ...
  async function wardTableFetcher(url, {
  ...
  function deleteIncomeCategory(row) {
    confirm({
      ...
      onAccept: async (done) => {
        try {
          let response = await axios.delete(`${Endpoint.DELETE_WARD}/${row.id}`);
      ...
      <div className="flex justify-between items-center space-x-2">
        ...
        <div>
          ...
          >
            ...
            <span className="text-white text-sm font-bold">Add Ward</span>
          </button>
        </div>
...
function WardTable({
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Community", accessor: "community.name" },
      {
        Header: "Date Created",
        accessor: "created_at",
...
function IncomeForm({
  ...
  function onSubmit(data) {
    ...
    doSubmission(Endpoint.POST_WARD, data, {
      ...
      onSuccess: (successMessage) => {
        setShowForm(false);
        setServerError(null);
        toast.success("Ward added", successMessage)
        reset();
        refreshTable();
      },
    });
  ...
  return (
    <Modal
      ...
      show={showForm}
      title="Register New Ward"
      top="top-6"
      width="lg"
      subTitle="Enter the details below to register a new ward to the system"
      >
      <div>
        {serverError && (
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="h-96 px-4 overflow-y-auto">
            <div className="flex justify-between mb-10">
              <div className="w-full mr-8">
                ...
                />
                {errors.name && (
                  <FieldError>Ward Name is required</FieldError>
                )}
              </div>
            ...
            <div className="flex justify-between mb-10">
              <div className="w-full">
                ...
                />
                {errors.description && (
                  <FieldError>Ward Description is required</FieldError>
                )}
              </div>
            </div>
          ...
          <div className="flex justify-center mt-10">
            ...
            >
              {initialValue ? "Edit Ward" : "Add Ward"}
            </Button>
          </div>
        </form>
      </div>
