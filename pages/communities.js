...
export default function Page() {
  ...
  const {
    ...
    user?.code == "00" 
    ? [Endpoint.FETCH_COMMUNITIES, tableState]
    : null,
    communityTableFetcher
  );
  ...
  async function communityTableFetcher(url, {
    ...
    const { description, name, code, ...remainingFilters } = userFilters;
  ...
  function deleteIncomeCategory(row) {
    confirm({
      ...
      onAccept: async (done) => {
        try {
          let response = await axios.delete(`${Endpoint.DELETE_COMMUNITY}/${row.id}`);
  ...
  return (
    <div className="flex">
      ...
      <div className="flex justify-between items-center space-x-2">
        <Card
          title="Communities"
          value={communityTableData?.total || 0}
        ...
        <div>
          ...
          >
            ...
            <span className="text-white text-sm font-bold">Add Community</span>
          </button>
        </div>
      ...
      <div className="mt-[1.5rem] mb-[2rem]">
        <CommunityTable 
          data={communityTableData?.content || []}
...
function CommunityTable({
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Ward", accessor: "ward.name" },
      {
        Header: "Date Created",
        accessor: "ward.created_at",
...
function IncomeForm({
  ...
  function onSubmit(data) {
    ...
    doSubmission(Endpoint.POST_COMMUNITY, data, {
      ...
      onSuccess: (successMessage) => {
        setShowForm(false);
        setServerError(null);
        toast.success("Community added", successMessage)
        reset();
        refreshTable();
      },
    });
  ...
  return (
    <Modal
      ...
      show={showForm}
      title="Register New Community"
      top="top-6"
      width="lg"
      subTitle="Enter the details below to register a new community to the system"
      >
      <div>
        {serverError && (
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="h-96 px-4 overflow-y-auto">
            <div className="flex justify-between mb-10">
              <div className="w-full mr-8">
                ...
                />
                {errors.name && (
                  <FieldError>Community Name is required</FieldError>
                )}
              </div>
              <div className="w-full">
                ...
                />
                {errors.code && (
                  <FieldError>Code is required</FieldError>
                )}
              </div>
            </div>
            ...
            <div className="flex justify-between mb-10">
              <div className="w-full">
                ...
                />
                {errors.description && (
                  <FieldError>Community Description is required</FieldError>
                )}
              </div>
            </div>
          ...
          <div className="flex justify-center mt-10">
            ...
            >
              {initialValue ? "Edit Community" : "Add Community"}
            </Button>
          </div>
        </form>
      </div>
